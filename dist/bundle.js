...
var CulqiContext = /*#__PURE__*/reactExports.createContext({
  openCulqi: function openCulqi() {},
...
var culqiId$1 = 'culqi-js';
var culqiUrl$1 = "".concat(baseCulqiUrl$1, "/js/v4");
var CulqiCheckoutV4 = function CulqiCheckoutV4(props) {
  var _useState = reactExports.useState(props.options.amount || 0),
  ...
  var getCulqiSettings = function getCulqiSettings() {
    var _props$options = props.options,
      _props$options$curren = _props$options.currency,
      currency = _props$options$curren === void 0 ? 'PEN' : _props$options$curren,
      _props$options$descri = _props$options.description,
      description = _props$options$descri === void 0 ? '' : _props$options$descri,
      _props$options$title = _props$options.title,
      title = _props$options$title === void 0 ? '' : _props$options$title;
    return {
      amount: amount,
      currency: currency,
  ...
  var onCulqiLoad = function onCulqiLoad(e) {
    if (window.Culqi) {
      initCulqi();
    }
  };
  var onCulqiEvent = function onCulqiEvent(messageEvent) {
    ...
    if (typeof data === 'string' && data === culqiMessages$1.closed) {
      onClose && onClose();
      initCulqi();
    }
  ...
  var openCulqi = function openCulqi() {
    if (window.Culqi) {
      window.Culqi.open();
    }
  };
  var setCulqiOptions = function setCulqiOptions(userOptions) {
    if (Object.keys(userOptions).length > 0 && window.Culqi) {
      window.Culqi.options(userOptions);
    }
  };
  var setCulqiSettings = function setCulqiSettings(settings) {
    if (window.Culqi) {
  ...
  return /*#__PURE__*/React.createElement(CulqiContext.Provider, {
    value: {
      openCulqi: openCulqi,
      amount: amount,
      token: token,
...
var culqiUrl = "".concat(baseCulqiUrl, "/js/v3");
var CulqiCheckoutV3 = function CulqiCheckoutV3(props) {
  var _useState = reactExports.useState(props.options.amount || 0),
    _useState2 = _slicedToArray(_useState, 2),
    amount = _useState2[0],
    setAmount = _useState2[1];
...
exports.Culqi = Culqi;
exports.CulqiProviderV3 = CulqiCheckoutV3;
exports.CulqiProviderV4 = CulqiCheckoutV4;
